...
class TestPaperwork(unittest.TestCase):
    ...
    @patch('paperwork.wrapper.api.list_tags')
    @patch('paperwork.wrapper.api.list_notebooks')
    @patch('paperwork.wrapper.api.list_notebook_notes')
    ...
    @patch('paperwork.wrapper.api.update_notebook')
